...
int main(int argc, char *argv[]) {
    ...
    // My Additional Tests Check For Proper Malformed Strings Handling

    puts("\nMy Additional Tests:\nThe Following Shouls Be 3 \"Malformed Strings\"\n");
    if(decode("0l1a2b3s") != -1) { // This Malformed String Should Not Start With '0'
      fprintf(stderr, "error: \"0l1a2b3s\" did not return the correct integer value\n");
    }

    if(decode("1ll2a3b4s") != -1) { // This Malformed String Should Not Have Two 'l' Back To Back
      fprintf(stderr, "error: \"1ll2a3b4s\" did not return the correct integer value\n");
    }

    if(decode("123456") != -1) { // This Malformed String Should Have At Least One Letter
      fprintf(stderr, "error: \"123456\" did not return the correct integer value\n");
    }
